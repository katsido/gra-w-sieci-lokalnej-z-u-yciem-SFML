...
void wczytaj_plansze(int ktora) {
	...
	string nazwa = "mapa" + to_string(ktora) + ".txt";
	char tab2[1024];
	strcpy(tab2, nazwa.c_str());
...
int main()
{
	...
	if (bedzie_gra == Tak) {
		...
		string nazwa2 = "klocek" + to_string(ktora) + ".png";
		string nazwa3 = "background" + to_string(ktora) + ".png";
		...
		Texture pistolet;
		if (!pistolet.loadFromFile("pistolet.png")) {
		...
		if (!pTexture.loadFromFile("brud_32c.png"))
		{
		...
		if (!pTextureM.loadFromFile("brud_32.png"))
		{
		...
		if (!pTextureS.loadFromFile("serca1.png"))
		{
		...
		if (!pTextureF.loadFromFile("fale2.png"))
		{
